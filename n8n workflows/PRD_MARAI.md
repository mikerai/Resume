...
**IMPORTANT**
The product requirements request must be clear, concise, and cover all essential aspects of the product. Avoid using jargon or abbreviations that may be unfamiliar to the product development team.
The output of the PRD, including titles, sections, bullet points, and all other content, must be in the language of the original language input by the user.
