// mantex-mobile/src/composables/useClientBranches.js
// Composable for fetching and managing client branches (mobile version)
...
export function useClientBranches() {
    ...
    /**
     * Get branch display name with location (mobile-friendly)
     * @param {Object} branch - Branch object
    ...
    const getBranchDisplayName = (branch) => {
        ...
        const hqPrefix = branch.is_headquarters ? '(Matriz) ' : '';
        return `${hqPrefix}${branch.name} - ${branch.municipality_city}`;
    };
