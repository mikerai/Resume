// mantex-mobile/src/composables/useClientAssets.js
// Composable for fetching and managing client assets (mobile version)
...
export function useClientAssets() {
    ...
    /**
     * Get asset display name with category (mobile-friendly, shorter)
