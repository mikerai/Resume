<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Gestiona Desde Cualquier Lugar</div>
            <span class="text-muted-color text-2xl">Tu negocio no se detiene, tu plataforma tampoco</span>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                ...
                <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">App Móvil Completa</div>
                <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
                    >Crea tickets, recibe cotizaciones y da seguimiento desde tu teléfono. Disponible para iOS y Android. Notificaciones en tiempo real para que nunca pierdas una actualización importante.</span
                >
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                ...
                <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Panel Web Profesional</div>
                <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px"
                    >Accede a reportes detallados, gestiona múltiples sucursales y controla tu inventario de activos desde tu computadora. Ideal para gerentes y administradores que necesitan una vista completa del negocio.</span
                >
            </div>
