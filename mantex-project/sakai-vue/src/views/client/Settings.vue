                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-4">
                            <Button 
                                ...
                                @click="layoutConfig.darkTheme = false; toggleDarkMode()" 
                                class="flex-1"
                            />
                            <Button 
                                icon="pi pi-moon" 
                                label="Oscuro" 
                                :outlined="!isDarkTheme" 
                                @click="layoutConfig.darkTheme = true; toggleDarkMode()" 
                                class="flex-1"
                            />
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                :class="['border-none w-6 h-6 rounded-full p-0 cursor-pointer outline-none outline-offset-1', { 'outline-primary': layoutConfig.primary === primaryColor.name }]"
